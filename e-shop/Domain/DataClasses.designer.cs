...
namespace Domain
{
    ...
    partial void DeleteProductDescription(ProductDescription instance);
		...
		public DataClassesDataContext() : 
				base(global::Domain.Properties.Settings.Default.AdventureWorks2012ConnectionString1, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductCategory", Storage="_ProductCategory", ThisKey="ProductID", OtherKey="ProductID", IsUnique=true, IsForeignKey=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductDescription", Storage="_ProductDescription", ThisKey="ProductID", OtherKey="ProductID", IsUnique=true, IsForeignKey=false)]
    ...
    partial void OnProductIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ProductCategoryID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true)]
			...
			set
			{
							...
							|| (this._Product.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ProductCategory = null;
					}
					this._Product.Entity = value;
					if ((value != null))
					{
						value.ProductCategory = this;
    ...
    partial void OnProductIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ProductDescriptionID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true)]
		...
		public Product Product
		{
			...
			set
			{
							...
							|| (this._Product.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Product.Entity = null;
						previousValue.ProductDescription = null;
					}
					this._Product.Entity = value;
					if ((value != null))
					{
						value.ProductDescription = this;
						this._ProductID = value.ProductID;
					}
					else
					{
