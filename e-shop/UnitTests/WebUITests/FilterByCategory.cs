...
namespace UnitTests.WebUITests
{
    ...
    public class FilterByCategory
    {
        ...
        public void Can_Filter_Products()// проверка корректности фильтрации по категории
        {
            ...
            Assert.IsTrue(result[0].Name == "P2" && result[0].ProductSubcategory.ProductCategory.Name == "Cat2");
            Assert.IsTrue(result[1].Name == "P4" && result[1].ProductSubcategory.ProductCategory.Name == "Cat2");
        }
    }
}
